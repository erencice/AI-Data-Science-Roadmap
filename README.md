...
- Think Stats — Allen B. Downey — [Think Stats](https://allendowney.github.io/ThinkStats/)
- Think Bayes — Allen B. Downey — [Think Bayes](https://allendowney.github.io/ThinkBayes2/)
...
- Introduction to Probability — Grinstead & Snell — [Probability (PDF)](https://math.dartmouth.edu/~prob/prob/prob.pdf)
...
Week 46 — Linear Combinations of Random Variables (Lesson 2)
...
Week 47 — Graphical Display of Multivariate Data (Lesson 3)
...
Week 48 — Multivariate Normal Distribution (Lesson 4)
...
Week 49 — Sample Mean Vector and Sample Correlation (Lesson 5)
...
Week 50 — Multivariate Conditional Distribution and Partial Correlation (Lesson 6)
...
Week 51 — Inferences Regarding Multivariate Population Mean (Lesson 7)
...
Week 52 — Multivariate Analysis of Variance (MANOVA) (Lesson 8)
...
Week 53 — Repeated Measures Analysis (Lesson 9)
...
Week 54 — Discriminant Analysis (Lesson 10)
...
Week 55 — Principal Components Analysis (Lesson 11)
...
Week 56 — Factor Analysis (Lesson 12)
...
Week 57 — Canonical Correlation Analysis (Lesson 13)
...
Week 58 — Cluster Analysis (Lesson 14)
...
Week 59 — Integration and Review
...
Weeks 68–71 — Flexible Imputation of Missing Data (complete)
...
Week 73 — ISLP Ch. 3 (Linear Regression)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 74 — ISLP Ch. 4 (Classification)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 75 — ISLP Ch. 5 (Resampling Methods)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 76 — ISLP Ch. 6 (Model Selection & Regularization)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 77 — ISLP Ch. 7 (Beyond Linearity)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 78 — ISLP Ch. 8 (Tree-Based Methods)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 79 — ISLP Ch. 9 (Support Vector Machines)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Week 80 — ISLP Ch. 10 (Unsupervised Learning)
- 📖 Activities: [ISLP](https://www.statlearning.com/)
...
Weeks 105–109 — Interpretable ML (complete)
...
Week 111 — ESL Ch. 4–5: Linear Classification & Basis Expansions
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 112 — ESL Ch. 6–7: Kernel Methods & Model Assessment
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 113 — ESL Ch. 8–9: Model Inference & Additive Models
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 114 — ESL Ch. 10: Boosting & Additive Models
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 115 — ESL Ch. 11–12: Neural Networks & Support Vector Machines
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 116 — ESL Ch. 13–14: Prototype Methods & Unsupervised Learning
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 117 — ESL Ch. 15: Random Forests
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 118 — ESL Ch. 16–17: Ensemble Learning & Graphical Models
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 119 — ESL Ch. 18 & Integration: High-Dimensional Problems
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Weeks 166–175 — Lütkepohl (complete)
...
- Flexible Imputation of Missing Data — Weeks 68–71 — [FIMD](https://stefvanbuuren.name/fimd/)
- ISLP (Statistical Learning with Python) — Weeks 72–81 — [ISLP](https://www.statlearning.com/)
- Data Mining: Concepts and Techniques (3e) — Weeks 82–90 — [Data Mining 3e (PDF)](https://myweb.sabanciuniv.edu/rdehkharghani/files/2016/02/The-Morgan-Kaufmann-Series-in-Data-Management-Systems-Jiawei-Han-Micheline-Kamber-Jian-Pei-Data-Mining.-Concepts-and-Techniques-3rd-Edition-Morgan-Kaufmann-2011.pdf)
- PRML (Bishop) — Weeks 91–105 — [PRML (PDF)](https://www.microsoft.com/en-us/research/uploads/prod/2006/01/Bishop-Pattern-Recognition-and-Machine-Learning-2006.pdf)
- Interpretable Machine Learning — Weeks 105–109 — [Interpretable ML](https://christophm.github.io/interpretable-ml-book/)
- The Elements of Statistical Learning (Hastie, Tibshirani, Friedman) — Weeks 110–119 — [ESL](https://hastie.su.domains/ElemStatLearn/)
- Dive into Deep Learning — Weeks 120–127 — [D2L](https://d2l.ai)
- The Illustrated Transformer — Week 128 — [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/)
- Deep Learning — Weeks 129–139 — [Deep Learning Book](https://www.deeplearningbook.org/)
- HF Course + HF Agents — Weeks 140–143 — [HF Course](https://huggingface.co/course/chapter1), [HF Agents](https://huggingface.co/learn/agents-course/unit0/introduction)

...
Week 133 — ESL Ch. 4–5: Linear Classification & Basis Expansions
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 134 — ESL Ch. 6–7: Kernel Methods & Model Assessment
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 135 — ESL Ch. 8–9: Model Inference & Additive Models
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 136 — ESL Ch. 10: Boosting & Additive Models
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 137 — ESL Ch. 11–12: Neural Networks & Support Vector Machines
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 138 — ESL Ch. 13–14: Prototype Methods & Unsupervised Learning
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 139 — ESL Ch. 15: Random Forests
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 140 — ESL Ch. 16–17: Ensemble Learning & Graphical Models
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 141 — ESL Ch. 18 & Integration: High-Dimensional Problems
- 📖 [ESL](https://hastie.su.domains/ElemStatLearn/)
...
Week 166 — The Illustrated Transformer (Bridge)
...
Weeks 167–177 — Deep Learning Book (Complete)
...
Weeks 186–193 — Machine Learning Systems
...
Weeks 194–201 — Data Engineering Zoomcamp
...
- Causal Inference: The Mixtape (Cunningham) — Weeks 112–121 — [The Mixtape](https://mixtape.scunning.com)
- Convex Optimization (Boyd & Vandenberghe) — Weeks 122–131 — [Convex Optimization (PDF)](https://stanford.edu/~boyd/cvxbook/bv_cvxbook.pdf)
- The Elements of Statistical Learning (Hastie, Tibshirani, Friedman) — Weeks 132–141 — [ESL](https://hastie.su.domains/ElemStatLearn/)
- R for Data Science (2e) — Weeks 142–151 — [R for Data Science (2e)](https://r4ds.hadley.nz)
- Beautiful Soup — Week 152 — [Beautiful Soup](https://www.crummy.com/software/BeautifulSoup/bs4/doc/)
- Selenium (Python) — Weeks 153–154 — [Selenium (Python)](https://selenium-python.readthedocs.io/index.html)
- SQL Roadmap (GeeksforGeeks) — Weeks 155–157 — [SQL Roadmap](https://www.geeksforgeeks.org/blogs/sql-roadmap/)
- Dive into Deep Learning — Weeks 158–165 — [D2L](https://d2l.ai)
- The Illustrated Transformer — Week 166 — [The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/)
- Deep Learning — Weeks 167–177 — [Deep Learning Book](https://www.deeplearningbook.org/)
- MLOps Zoomcamp — Weeks 178–185 — [MLOps Zoomcamp](https://github.com/DataTalksClub/mlops-zoomcamp)
- Machine Learning Systems — Weeks 186–193 — [ML Systems](https://mlsysbook.ai)
- Data Engineering Zoomcamp — Weeks 194–201 — [DE Zoomcamp](https://github.com/DataTalksClub/data-engineering-zoomcamp)
- HF Course + HF Agents — Weeks 202–205 — [HF Course](https://huggingface.co/course/chapter1), [HF Agents](https://huggingface.co/learn/agents-course/unit0/introduction)
